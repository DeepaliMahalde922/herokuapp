  ...
  render() {
    ...
    if (dataitem) {
      renderItems = this.state.dataitems.map((item, index) => {
        ...
        console.log('articlestatus: '+item.articlestatus);
        ...
        return <Layout.Section key={index}>
              ...
              <Card title={protitle}>
                ...
                <div>
                  <span style={{"marginTop":35, "display":"inline-block"}}></span>
                  <Button primary onClick={() => this._showReviewArticle(item.id)}>Go to Review</Button>
